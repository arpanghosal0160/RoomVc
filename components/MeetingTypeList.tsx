...
const MeetingTypeList = () => {
  ...
  return (
    <section className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
      ...
      <HomeCard img="/icons/recordings.svg" title="View Recordings" description="View Your Recorded Meetings" handleClick={() => router.push('/recordings')} className="bg-purple-1"/>
      ...
      {!callDetails ? (
        ...
        >
          <div className="fle flex-col gap-2.5">
      ...
      <MeetingModal 
        ...
        onClose={() => setMeetingState(undefined)}
        title="Start a new Meeting Quickly"
        className="text-center"
